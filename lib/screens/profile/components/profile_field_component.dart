...
class _ProfileFieldComponentState extends State<ProfileFieldComponent> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.field.type == FieldType.textBox || widget.field.type == FieldType.url || widget.field.type == FieldType.wpTextbox) {
      return Container(
      ...
      return Container(
        ...
        child: AppTextField(
          ...
          onTap: () async {
            ...
            group.fields![group.fields!.indexOf(widget.field)].value = datePick.toString().splitBefore('.000');
